...
const CATEGORY_MAP = {
  ...
  'espresso_machine': {
    'commercial semi-automatic': 'commercial-semi-automatic',
    'commercial fully-automatic': 'commercial-fully-automatic',
    default: 'commercial-espresso-machine',
  },
  'roaster': {
    'commercial roaster': 'commercial-roaster',
    'small batch roaster': 'small-batch-roaster',
    default: 'roaster',
  },
  'scale': { default: 'scale' },
  'accessory': {
    'gift set': 'gift-set',
    'tamper': 'tamper',
    'electric tamper': 'electric-tamper',
    'distribution tool': 'distribution-tool',
    'espresso pressure monitor': 'espresso-pressure-monitor',
    'coffee analysis device': 'coffee-analysis-device',
    'roaster accessory': 'roaster-accessory',
    default: 'accessory',
  },
